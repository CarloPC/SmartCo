...
const foodAidSchedule = [
  { id: 1, purok: 'Purok 1', date: '2026-01-15', status: 'Scheduled', families: 24 },
  { id: 2, purok: 'Purok 2', date: '2026-01-16', status: 'In Progress', families: 18 },
  { id: 3, purok: 'Purok 3', date: '2026-01-17', status: 'Scheduled', families: 31 }
]
      ...
      <div className="p-4 space-y-4">
        ...
        <div className={`${
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <span className={`text-sm font-bold ${isDarkMode ? 'text-green-400' : 'text-green-600'}`}>67%</span>
          </div>
          <div className={`w-full rounded-full h-3 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
            ...
            } h-3 rounded-full`} style={{width: '67%'}}></div>
          </div>
          <p className={`text-xs mt-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>73 of 109 families served this month</p>
        </div>
                ...
                <div>
                  ...
                  <div className={`flex items-center space-x-4 mt-2 text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span>{schedule.families} families</span>
                    </div>
                  </div>
                </div>
